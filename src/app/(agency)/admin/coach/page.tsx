  ...
  return (
    <main style={{ height: "100dvh", minHeight: isMobile ? 0 : 720, background: "#fbfbfb", color: "#121a2e", overflow: "hidden", position: "relative", ...jakartaSans }}>
      ...
      <section style={{ position: "relative", zIndex: 3, height: "100%", minHeight: 0, paddingLeft: contentLeft, display: "flex", flexDirection: "column", transition: "padding-left 0.22s ease", overflow: "hidden" }}>
        ...
        <div style={{ flex: 1, minHeight: 0, overflowY: "auto", overflowX: "hidden", overscrollBehavior: "contain", padding: isMobile ? "22px 16px 150px" : isTablet ? "28px 32px 164px" : "34px 72px 164px", scrollBehavior: "smooth" }}>
          {messages.length === 0 ? (
        ...
        <div style={{ position: "absolute", left: contentLeft, right: 0, bottom: 0, zIndex: 7, padding: isMobile ? "0 12px calc(14px + env(safe-area-inset-bottom))" : isTablet ? "0 24px 28px" : "0 48px 34px", transition: "left 0.22s ease" }}>
